...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[23] = {1620000,  1, 0x1D, 1225000, 1275000, 4},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_hate[] = {
  ...
  { {1, 0}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(18), 1175000, 0x03006000},
  { {1, 0}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(19), 1200000, 0x03006000},
  { {1, 0}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(19), 1225000, 0x03006000},
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(20), 1225000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(21), 1250000, 0x03006000},
  { {1, 0}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(22), 1275000, 0x03006000},
  { {1, 0}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(22), 1275000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(22), 1325000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(22), 1325000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(23), 1350000, 0x03006000},
  { {0, 0}, 0 },
};
