...
static struct msm_bus_paths bw_level_tbl[] = {
	[0] =  BW_MBPS(1336), /* At least 167 MHz on bus. */
	[1] = BW_MBPS(2008), /* At least 251 MHz on bus. */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[16] = {1242000,  1, 0x17, 1200000, 1212500, 2},
	[17] = {1296000,  1, 0x18, 1200000, 1225000, 3},
	[18] = {1350000,  1, 0x19, 1200000, 1225000, 3},
	[19] = {1458000,  1, 0x1B, 1200000, 1250000, 4},
	[20] = {1566000,  1, 0x1D, 1200000, 1250000, 4},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_hate[] = {
  ...
  { {1, 0}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(18), 1200000, 0x03006000},
  { {1, 0}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(19), 1225000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(20), 1250000, 0x03006000},
  { {1, 0}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(20), 1325000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(20), 1350000, 0x03006000},
  { {0, 0}, 0 },
};
